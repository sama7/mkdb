...
import type { FiltersState, GenreFilters } from '../types';
...
const Filters = ({ filters, onFiltersChange }: FiltersProps) => {
    ...
    const [selectedGenres, setSelectedGenres] = useState<GenreFilters>({}); // store the selected genres state
    ...
    const toggleGenre = (genre: string) => {
        ...
        const updatedGenres: GenreFilters = { ...selectedGenres };
        if (newState) {
